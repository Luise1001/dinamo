<nav class="navbar navbar-expand-lg fixed-bottom bg-primary-color">
    <div class="px-3 pe-3 d-flex justify-content-between w-100">
        ...
        <a class="text-center d-grid nav-link text-neutral-medium fs-075" href="{{ route('dashboard') }}">
            <div>
        ...
        <a class="text-center d-grid nav-link text-neutral-medium fs-075" href="{{ route('profile') }}">
            <div>
