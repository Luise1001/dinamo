    ...
    <div class="p-2 m-2 card">
        <form action="{{ route('places.update') }}" method="post">
            ...
            <div>
                ...
                <input class="form-control" id="name" name="name" type="text" placeholder="Nombre" value="{{ $place->name }}">
            </div>

            <div class="mt-1">
                <label for="adress" class="fw-semibold text-primary-color required">Dirección</label>
                <input class="form-control" id="address" name="address" type="text" placeholder="Buscar dirección" value="{{ $place->address }}">
