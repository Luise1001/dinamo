...
<?php $__env->startSection('content'); ?>
    <div class="">
        <img class="opacity-25 background-image position-absolute" src="<?php echo e(asset('assets/media/images/background.jpg')); ?> "
            alt="background">
        <div class="p-3 mb-5 fixed-bottom">
            <div class="mt-5 text-center">
                <img with="100px" height="100px" src="<?php echo e(asset('assets/media/icons/logo.svg')); ?>" alt="Logo">
                <h1 class="text-primary-color fw-bold">DINAMO</h1>
            </div>

            <div class="flex-wrap mb-5 text-center d-flex">
                <a href="<?php echo e(route('login')); ?> " class="mb-2 text-white btn btn-mid w-100 bg-primary-color">
                    Iniciar sesión
                </a>

                <a href="<?php echo e(route('register')); ?> " class="mb-2 text-white btn btn-mid w-100 bg-primary-light">
                    Registrarse
                </a>
...
<?php echo $__env->make('app.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/index.blade.php ENDPATH**/ ?>