    ...
    <div class="">
        ...
        <div class="p-3 mb-5 fixed-bottom">
            ...
            <div class="flex-wrap mb-5 text-center d-flex">
                <a href="<?php echo e(route('login')); ?> " class="mb-2 text-white btn btn-mid w-100 bg-dark-green">
                    Iniciar sesión
                </a>

                <a href="<?php echo e(route('register')); ?> " class="mb-2 text-white btn btn-mid w-100 bg-light-green">
                    Registrarse
                </a>
