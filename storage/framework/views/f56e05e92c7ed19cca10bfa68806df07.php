...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/app/layouts/menu/navbar/navbar.css')); ?> ">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/app/layouts/menu/footer/footer.css')); ?> ">
